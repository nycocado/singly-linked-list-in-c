...
void setUp(void) { list = list_create(); }

void tearDown(void) { list_destroy(list, NULL); }

/*******************************************************************************
 Helper functions.
 ******************************************************************************/

bool is_equal(void* a, void* b) { return a == b; }
...
void insert_number(int number) { insert_numbers(number, number); }

int* number_address_of(int number) { return &(numbers[number - 1]); }
...
void insert_string(int str_idx) { insert_strings(str_idx, str_idx); }

char** string_address_of(int str_idx) { return &(strings[str_idx - 1]); }
...
void free_int(int* i) { free(i); }

/*******************************************************************************
 Tests
 ******************************************************************************/

void test_list_is_empty() { TEST_ASSERT(list_is_empty(list)); }
...
void test_list_remove()
{
    ...
    TEST_ASSERT_EQUAL(
        string_address_of(6), list_remove(list, list_size(list) - 1)
    );
...
void test_list_count_all()
{
    TEST_ASSERT_EQUAL(
        0,
        list_count_all(
            list, (bool (*)(void*, void*))equal_to_string, &strings[0]
        )
    );
    insert_strings(1, 3);
    insert_strings(1, 3);
...
void test_list_remove_all()
{
    ...
    TEST_ASSERT_EQUAL(5, list_size(list));
    TEST_ASSERT_EQUAL(
        1, list_find(list, (bool (*)(void*, void*))equal_to_string, &strings[1])
    );
    int count = list_remove_all(
        list, (bool (*)(void*, void*))equal_to_string, NULL, &strings[1]
    );
    TEST_ASSERT_EQUAL(2, count);
    TEST_ASSERT_EQUAL(3, list_size(list));
    TEST_ASSERT_EQUAL(
        -1,
        list_find(list, (bool (*)(void*, void*))equal_to_string, &strings[1])
    );
    TEST_ASSERT_EQUAL(string_address_of(3), list_get_last(list));
    count = list_remove_all(
        list, (bool (*)(void*, void*))equal_to_string, NULL, &strings[2]
    );
    TEST_ASSERT_EQUAL(2, count);
    ...
    TEST_ASSERT_EQUAL(string_address_of(3), list_get_last(list));
    count = list_remove_all(
        list, (bool (*)(void*, void*))equal_to_string, NULL, &strings[0]
    );
...
void test_list_remove_all_custom_free()
{
    ...
    int count = list_remove_all(
        list,
        (bool (*)(void*, void*))equal_to_string,
        (void (*)(void*))free_str,
        &str_match
    );
    TEST_ASSERT_EQUAL(1, count);
...
void test_list_remove_duplicates()
{
    ...
    insert_strings(2, 3);
    TEST_ASSERT_EQUAL(5, list_size(list));
    int count = list_remove_duplicates(
        list, (bool (*)(void*, void*))equal_to_string, NULL, &strings[1]
    );
    TEST_ASSERT_EQUAL(2, count);
}
